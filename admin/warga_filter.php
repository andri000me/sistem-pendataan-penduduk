...
<div class="container-fluid">
	...
	<div class="card" >
		<div class="card-body">
			...
			<a class="btn btn-success btn-sm mb-3 float-right" href="warga_cetak_filter.php?desa=<?php echo $id_desa; ?>" target="blank">Cetak</a>
			...
			<table class="table table-bordered table-hover table-striped table-saya">
				...
				<tr>
					...
					<td>
						...
						<a href="warga_hapus.php?id=<?php echo $w['warga_id']; ?>" class="btn btn-danger text-white btn-sm">Hapus</a>
					</td>
				</tr> 
				<?php 
				}
