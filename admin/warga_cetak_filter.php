	...
	<table class="table table-bordered table-hover table-striped table-saya">
					...
					<tbody>
						...
						$no = 1;
						$id_desa = $_GET['desa'];
						$warga = mysqli_query($koneksi,"SELECT * FROM warga,desa,dusun WHERE warga_desa=desa_id and warga_dusun=dusun_id and warga_desa='$id_desa' ORDER BY warga_id ASC");
