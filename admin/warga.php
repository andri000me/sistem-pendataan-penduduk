...
<div class="container-fluid">
	...
	<div class="card" >
		<div class="card-body">
			...
			<a href="warga.php"><h3>Data Warga</h3></a>
			<p class="tex-muted">Semua Data Warga</p>
			...
			<form method="get" action="warga_filter.php">
				...
				<input type="submit" name="submit" value="Tampilkan Data" class="btn btn-secondary mb-3 btn-sm">
			</form>
						</div>
					</div>
				</div>
			...
			<a class="btn btn-success btn-sm mb-3 float-right" href="warga_cetak.php" target="blank"><i class="fa fa-file"></i> Cetak</a>
			...
			<table class="table table-bordered table-hover table-striped table-saya">
				...
				<tr>
					...
					<td>
						...
						<a href="warga_hapus.php?id=<?php echo $w['warga_id']; ?>" class="btn btn-danger text-white btn-sm"><i class="fa fa-trash"></i></a>
					</td>
				</tr> 
				<?php 
				}
